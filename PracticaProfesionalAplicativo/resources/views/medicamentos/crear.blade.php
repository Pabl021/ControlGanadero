...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading" style="color: #000000;">Crear medicamentos</h3>
    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select required  name="nombreCategoria" class="form-control" value="" autocomplete="off" autofocus>
                                        <option value="" selected disabled>Seleccionar Categoría</option>
                                            @foreach ($medicamentos as $med)
                                            <option value="{{$med->id}}">{{$med->nombreCategoria}}</option>
                                            @endforeach
                                        </select>
