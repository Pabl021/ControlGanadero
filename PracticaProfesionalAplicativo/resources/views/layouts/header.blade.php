<form class="form-inline mr-auto" action="#" >
    <ul class="navbar-nav mr-3" >
        <li ><a href="#" data-toggle="sidebar" class="nav-link nav-link-lg" style="color: #000000;"><i class="fas fa-bars" ></i></a></li>
    </ul>
</form>
<ul class="navbar-nav " style="background-color: #9AA49F;">
