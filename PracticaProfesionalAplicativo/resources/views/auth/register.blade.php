...
<body style=" background-image:url('{{ asset('img/fondoGan.jpg') }}');">
    ...
    <div class="card card-info">
        <div class="card-header" ><h4 style="color:black">Registrar cuenta</h4></div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="firstName" type="text"
                                   ...
                                   name="name"
                                   tabindex="1" placeholder="Digite su nombre completo" value="{{ old('name') }}"
                                   autofocus required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="email" type="email"
                                   ...
                                   placeholder="Digite su correo electronico" name="email" tabindex="1"
                                   value="{{ old('email') }}"
                                   required autofocus>
                            <div class="invalid-feedback">
                                {{ $errors->first('email') }}
    ...
    Ya tienes una cuenta ?<a
                href="{{ route('login') }}" style="color:darkturquoise ;"> Loguearme</a>
    </div>
@endsection
